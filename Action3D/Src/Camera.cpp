...
void CCamera::Update()
{
    ...
    transform.rotation.y += RsticX() * ROTATE_SPEED * DegToRad;
    transform.rotation.x += RsticY() * ROTATE_SPEED * DegToRad;
    ...
    VECTOR3 comPos = transform.position + eyePt + plPos;
    VECTOR3 camLook = transform.position + lookPt * mat + plPos; // Look‚Í‚˜‚Æ‚š‚ª‚O‚¾‚©‚ç‰ñ“]i–matj‚µ‚Ä‚à•Ï‚í‚ç‚È‚¢ (1, 2, 0)‚É‚·‚é‚ÆŽ‹“_‚ªŽÎ‚ßŒã‚ë‚É‚È‚é
